...
public class ShaderBus {
  ...
  public static void init() {
    vertex_raw_color_2d =
        Shader.createShader("sowr/graphic/shader/raw_color_2d.vsh", ShaderType.VERTEX, true);
    fragment_raw_color_2d =
        Shader.createShader("sowr/graphic/shader/raw_color_2d.fsh", ShaderType.FRAGMENT, true);

    vertex_raw_texture_2d =
        Shader.createShader("sowr/graphic/shader/raw_texture_2d.vsh", ShaderType.VERTEX, true);
    fragment_raw_texture_2d =
        Shader.createShader("sowr/graphic/shader/raw_texture_2d.fsh", ShaderType.FRAGMENT, true);
  }

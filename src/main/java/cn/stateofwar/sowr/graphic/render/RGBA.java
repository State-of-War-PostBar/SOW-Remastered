...
public class RGBA {
  ...
  /**
   * Convert the color components to a float array with 4 elements (red, green, blue, alpha)
  ...
  /**
   * Convert the color components to a float buffer with 4 elements (red, green, blue, alpha).
   *

...
/**
 * Logger for the program. For every class that requires log recording, it needs an instance of this
 * class.
 */
public class Logger {
   ...
   * <i>This should only be called once, otherwise the old log file will be erased.</i>
   */
  public void init() {
    try {
   ...
   * This type of log messages records something that is not expected when running, but they might
   * not trigger huge impacts.
   *
   * @param message The message to record.
   */
   ...
   * This type of log messages records the errors that disable some of the program. Although they
   * might not be very dangerous, users should take a look at this and report to the development
   * team.
   *
   * @param message The message to record.
   */
   ...
   * This type of log messages records some critical error that makes it impossible to run anymore.
   *
   * @param message The message to record.
   */

...
public class DataUtils {
  ...
  /**
   * Convert some X-Y-Z coordinates of the screen to an array of OpenGL coordinates.
   *
  ...
  /**
   * Convert a S-T coordinate point in pixels of a texture to OpenGL texture coordinate.
   *
